...
/**
 * Created by HanifAlKamal on 18/11/2017.
 */
...
public class httpRequest extends AsyncTask<String, Void, String> {
    ...
    public httpRequest(Context context, AsyncResponse asyncResponse) {
        this.asyncResponse = asyncResponse;
        this.context = context;
    }

    public httpRequest(Context context, boolean showLoadingMessage, AsyncResponse asyncResponse) {
        this.asyncResponse = asyncResponse;
        this.context = context;
        this.showLoadingMessage = showLoadingMessage;
    }

    public httpRequest(Context context, HashMap<String, String> postData, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
        this.asyncResponse = asyncResponse;
    }

    public httpRequest(Context context, HashMap<String, String> postData, boolean showLoadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
        this.asyncResponse = asyncResponse;
        this.showLoadingMessage = showLoadingMessage;
    ...
    public httpRequest(Context context, String loadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
        this.loadingMessage = loadingMessage;
        this.asyncResponse = asyncResponse;
    }

    public httpRequest(Context context, HashMap<String, String> postData, String loadingMessage, AsyncResponse asyncResponse) {
        this.context = context;
        this.postData = postData;
        this.loadingMessage = loadingMessage;
        this.asyncResponse = asyncResponse;
...
//        if(this.showLoadingMessage && this.progressDialog.isShowing()) {
 ...
 //       }
    ...
    /** @deprecated */
    @Deprecated
    public httpRequest(AsyncResponse asyncResponse) {
        this.asyncResponse = asyncResponse;
    ...
    /** @deprecated */
    @Deprecated
    public httpRequest(AsyncResponse asyncResponse, HashMap<String, String> postData) {
        this.asyncResponse = asyncResponse;
        this.context = (Context)asyncResponse;
        this.postData = postData;
    }
    ...
    /** @deprecated */
    @Deprecated
    public httpRequest(AsyncResponse asyncResponse, String loadingMessage) {
        this.asyncResponse = asyncResponse;
        this.context = (Context)asyncResponse;
        this.loadingMessage = loadingMessage;
    }
    ...
    /** @deprecated */
    @Deprecated
    public httpRequest(AsyncResponse asyncResponse, HashMap<String, String> postData, String loadingMessage) {
        this.asyncResponse = asyncResponse;
        this.context = (Context)asyncResponse;
        this.postData = postData;
        this.loadingMessage = loadingMessage;
